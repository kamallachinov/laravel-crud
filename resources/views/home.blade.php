                        ...
                        @foreach ($posts as $post)
                            <div
                                ...
                                <div class="mt-6 flex items-center justify-between">
                                    ...
                                    <form action="/delete-post/{{ $post->id }}" method="POST" class="inline-block">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit"
                                            class="px-4 py-2 bg-red-600 text-white font-medium text-sm rounded-md shadow hover:bg-red-700 transition duration-200">
                                            Delete
                                        </button>
                                    </form>
                                </div>
